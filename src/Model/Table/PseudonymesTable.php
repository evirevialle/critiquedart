 ...
 */
class PseudonymesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ->integer('idAuteur')
            ->requirePresence('idAuteur', 'create')
            ->notEmptyString('idAuteur');
        ...
        $validator
            ->scalar('pseudonyme')
            ->maxLength('pseudonyme', 255)
            ->requirePresence('pseudonyme', 'create')
            ->notEmptyString('pseudonyme');
