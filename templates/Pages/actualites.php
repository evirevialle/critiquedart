...
<div style="width: 710px; float: left;">
	...
	<div class="div_actualites">
		...
		<a class="telecharger_actualites" href="Appel_Critiques_Art_Mai_2017.pdf" target="_blank">Télécharger l’appel à communication du colloque<img src='/webroot/images/pdf.jpg' height='20' width='20' alt='logo PDF'></a>
	</div>
</div>
...
<div style="width: 360px; float: right;">
	<div class="div_actualites">
		...
		<a class="telecharger_actualites" href="Plaquette_JE_Juin_2015.pdf" target="_blank">Télécharger la plaquette de la journée d’études<img src='/webroot/images/pdf.jpg' height='20' width='20' alt='logo PDF'></a>
	</div>
</div>
