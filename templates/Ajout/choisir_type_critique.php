...
?>
	...
	<input type="reset" value="Abandonner la saisie de cette critique" onClick="document.location.replace('insertion');" style="margin: 20px 0;"/>
	
	<div id="transparent" style="visibility:hidden;"></div>
	<?= $this->Form->create(null, ['name'=>'critique','type'=>'get', 'url'=>'/ajout/test']); ?>
	<!--<form name="critique" method="get" action="/pages/test">-->
	<!-- Type de critique -->
